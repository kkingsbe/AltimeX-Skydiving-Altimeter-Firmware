...
int main(void)
{
  ...
  {
	//uint8_t[] data = {};
	//HAL_I2C_Master_Transmit (I2C_HandleTypeDef * hi2c1, uint16_t 0x47, uint8_t* pData, uint16_t Size, uint32_t Timeout);
	//HAL_I2C_Master_Receive (I2C_HandleTypeDef * hi2c1, uint16_t 0x47, uint8_t* pData, uint16_t Size, uint32_t Timeout);
