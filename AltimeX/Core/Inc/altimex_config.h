...
struct AltimexConfig {
		double ascentThreshold;             //The altitude you must pass for it to transition into the ascent state
		...
		double exit;                        //Exit altitude
		double breakoff;                    //Breakoff altitude
		double deploy;                      //Deployment altitude
		...
		double gearCheckAlt;                //The altitude that the gear check notification is given
